...
# IMPORTANTE revisar en MONGO ATLAS los permisos de acceso de IP para nuestro ambiente local, en Docker y en Kubernetes, en cada paso deberemos agregar la IP para que se pueda accesar a la DB
